...
**Symptom:** `/plugin install full@allay` succeeds but `/plugin list` doesn't show the sub-plugins.
...
- **Bug:** reproducible, unexpected behavior. File in [Issues](https://github.com/enchanted-plugins/allay/issues) with the bug template.
- **Question or "is this expected?":** open a thread in [Discussions](https://github.com/enchanted-plugins/allay/discussions).
...
Then: [Discussions Q&A](https://github.com/enchanted-plugins/allay/discussions/categories/q-a).
