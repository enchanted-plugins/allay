...
- The hook timed out. Hooks have per-event budgets; see [../vis/packages/core/conduct/hooks.md](../../vis/packages/core/conduct/hooks.md) § Performance budget.
...
**Cause:** Someone's error payload is unhelpful — see [../vis/packages/core/conduct/tool-use.md](../../vis/packages/core/conduct/tool-use.md) § Error payloads are contracts.
