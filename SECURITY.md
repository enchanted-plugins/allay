...
- **Primary channel:** [Open a private security advisory](https://github.com/enchanter-ai/emu/security/advisories/new) on this repository.
...
- Bypass of the shared [hooks contract](../enchanter-foundations/packages/core/conduct/hooks.md) — any hook that decides instead of advises.
