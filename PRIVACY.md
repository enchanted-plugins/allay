...
- The shared behavioral contract at [shared/foundations/conduct/hooks.md](shared/foundations/conduct/hooks.md) § Injection over denial forbids hooks from taking side effects on repo state (auto-commits, auto-renames). Emu's hooks adhere to this.
